...
public class Order {
    ...
    public Order(Integer id, String orderNo, Integer userId, Integer shippingId, BigDecimal payment, Integer paymentType, Integer postage, Integer status, Date paymentTime, Date sendTime, Date endTime, Date closeTime, Date createTime, Date updateTime, String address, String phone, String username, String wxnum, String orderno) {
        this.id = id;
